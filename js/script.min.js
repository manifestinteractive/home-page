...
a.wind.speed+" "+a.wind.direction+"</li></ul>";$(".weather").html(html)},error:function(a){$(".weather").html("<p>"+a+"</p>")}});$(".content .google").rssfeed("http://gplusrss.com/rss/feed/b9285465a5642f024e4365dfc45325b0525ebdeb5af94",{limit:20,header:!1,linktarget:"_blank"},function(){$(".content .google").prepend('<a name="google"></a>')});$(".content .github").rssfeed("https://github.com/manifestinteractive.private.atom?token=425e6ccb6c7d8d744dc93dafbcc09891",{limit:20,header:!1,linktarget:"_blank"},
function(){$(".content .github").prepend('<a name="github"></a>')});$(".content .linkedin").rssfeed("http://www.linkedin.com/rss/nus?key=SpbPKdYV0LKuR6wFHp8xD8YntSPi8PuJ6YLtf_SCZseKVcFounB0LYncptA9ubPew3",{limit:20,header:!1,linktarget:"_blank"},function(){$(".content .linkedin").prepend('<a name="linkedin"></a>')});$(".content .twitter").rssfeed("http://home.peterschmalfeldt.com/tweetledee/homerss.php",{limit:20,header:!1,linktarget:"_blank"},function(){$(".content .twitter").prepend('<a name="twitter"></a>')});
$(".content .newsfeed").rssfeed("http://feeds.theguardian.com/theguardian/technology/rss",{limit:20,header:!1,linktarget:"_blank"},function(){$(".content .newsfeed").prepend('<a name="newsfeed"></a>')})}
...
1)},0),window.addEventListener("orientationchange",function(){window.scrollTo(0,1)},!1));$(".toggle-fullscreen").click(function(){window.fullscreen?cancel_fullscreen():launch_fullscreen();return!1});$(".menu-list").click(function(){$(".submenu").fadeToggle("slow");hide_menu=setTimeout(function(){$(".submenu").fadeOut("slow")},window.timeout);window.location.href="#top";return!1});$(".refresh").click(function(){load_data();$(".refresh").addClass("spin");setTimeout(function(){$(".refresh").removeClass("spin")},
1E3);return!1});$(".submenu a").hover(function(){clearTimeout(hide_menu);hide_menu=setTimeout(function(){$(".submenu").fadeOut("slow")},window.timeout)});$(".submenu a").click(function(){clearTimeout(hide_menu);hide_menu=setTimeout(function(){$(".submenu").fadeOut("slow")},window.timeout);$(".submenu a").not(this).removeClass("active");$(this).toggleClass("active");var a=$(this).attr("class"),a=a.replace("active",""),a=a.replace("nobounce",""),a="."+a.replace(" ",""),b=a.replace(".","#");$(".fade-container").not(a).stop().hide();
$(".content .close").hide();$(".watermark").removeClass("watermark_bookmarks watermark_google watermark_github watermark_linkedin watermark_twitter watermark_newsfeed");$(this).hasClass("active")?($(a,".content").stop().fadeIn("fast").removeClass("blur").css({display:"inline-block"}).animate({scrollTop:"0"},0),$(".content .close").fadeIn("slow"),$(".content .close").css({left:$(".content .fade-container:visible").width()+45+"px"}),setTimeout(function(){$(".watermark").addClass("watermark_"+a.replace(".",
""))},250)):($(a,".content").stop().addClass("blur").fadeOut("fast"),$(".content .close").fadeOut("slow"));window.location.href=b;$(window).trigger("resize");return!1});$(".content .close").click(function(){$(".submenu a").removeClass("active");$(".content .fade-container").stop().addClass("blur").fadeOut("fast");$(".content .close").stop().hide();$(".watermark").removeClass("watermark_bookmarks watermark_google watermark_github watermark_linkedin watermark_twitter watermark_newsfeed");window.location.href=
"#top";return!1});$(".fade-container").bind("mousewheel",function(a,b){this.scrollTop+=30*(0>b?1:-1);a.stopPropagation();a.preventDefault()});$(window).resize(function(){$(".fade-container").css({height:$(document).height()-200+"px"});$(".content .close").css({left:$(".content .fade-container:visible").width()+45+"px"});var a=$(".content").width(),b=$(".content .fade-container:visible").width(),c=0.5*b,a=a-b+b/2-c/2;$(".watermark").css({right:a+"px","font-size":c+"px",top:100+b/2+"px"});window.scrollTo(0,
1)});use_keyboard_shortcuts&&(Mousetrap.bind("1",function(){$(".submenu a.bookmarks").trigger("click")}),Mousetrap.bind("2",function(){$(".submenu a.google").trigger("click")}),Mousetrap.bind("3",function(){$(".submenu a.github").trigger("click")}),Mousetrap.bind("4",function(){$(".submenu a.linkedin").trigger("click")}),Mousetrap.bind("5",function(){$(".submenu a.twitter").trigger("click")}),Mousetrap.bind("6",function(){$(".submenu a.newsfeed").trigger("click")}),Mousetrap.bind("c",function(){$(".close").trigger("click")}),
Mousetrap.bind("r",function(){$(".refresh").trigger("click")}),Mousetrap.bind("f",function(){$(".toggle-fullscreen").trigger("click")}),Mousetrap.bind("m",function(){$(".menu-list").trigger("click")}),Mousetrap.bind("up",function(a){var b=$(".fade-container:visible"),c=0.9*b.height();b.stop().animate({scrollTop:"-="+c+"px"},750);a.stopPropagation();a.preventDefault()}),Mousetrap.bind("down",function(a){var b=$(".fade-container:visible"),c=0.9*b.height();b.stop().animate({scrollTop:"+="+c+"px"},750);
a.stopPropagation();a.preventDefault()}),Mousetrap.bind("left",function(a){$(".submenu a.active").prev().trigger("click");a.stopPropagation();a.preventDefault()}),Mousetrap.bind("right",function(a){$(".submenu a.active").next().trigger("click");a.stopPropagation();a.preventDefault()}),Mousetrap.bind("home",function(a){$(".fade-container:visible").stop().animate({scrollTop:"0"},750);a.stopPropagation();a.preventDefault()}),Mousetrap.bind("end",function(a){$(".fade-container:visible").stop().animate({scrollTop:$(".fade-container:visible")[0].scrollHeight+
"px"},750);a.stopPropagation();a.preventDefault()}));setInterval(function(){$(".refresh").trigger("click")},6E4);setTimeout(load_data,500);start_time()});
