...
$(".content .close").hide();$(this).hasClass("active")?($(a,".content").stop().fadeIn("fast").removeClass("blur").css({display:"inline-block"}).animate({scrollTop:"0"},0),$(".content .close").fadeIn("slow"),$(".content .close").css({left:$(".content .fade-container:visible").width()+45+"px"})):($(a,".content").stop().addClass("blur").fadeOut("fast"),$(".content .close").fadeOut("slow"));window.location.href=b;return!1});$(".content .close").click(function(){$(".submenu a").removeClass("active");$(".content .fade-container").stop().addClass("blur").fadeOut("fast");
$(".content .close").stop().hide();window.location.href="#top";return!1});$(".fade-container").css({height:$(document).height()-200+"px"});$(".fade-container").bind("mousewheel",function(a,b){this.scrollTop+=30*(0>b?1:-1);a.stopPropagation();a.preventDefault()});$(window).resize(function(){$(".fade-container").css({height:$(document).height()-200+"px"});$(".content .close").css({left:$(".content .fade-container:visible").width()+45+"px"});window.scrollTo(0,1)});use_keyboard_shortcuts&&(Mousetrap.bind("1",
function(){$(".submenu a.bookmarks").trigger("click")}),Mousetrap.bind("2",function(){$(".submenu a.google").trigger("click")}),Mousetrap.bind("3",function(){$(".submenu a.github").trigger("click")}),Mousetrap.bind("4",function(){$(".submenu a.linkedin").trigger("click")}),Mousetrap.bind("5",function(){$(".submenu a.twitter").trigger("click")}),Mousetrap.bind("6",function(){$(".submenu a.newsfeed").trigger("click")}),Mousetrap.bind("c",function(){$(".close").trigger("click")}),Mousetrap.bind("r",
function(){$(".refresh").trigger("click")}),Mousetrap.bind("f",function(){$(".toggle-fullscreen").trigger("click")}),Mousetrap.bind("m",function(){$(".menu-list").trigger("click")}),Mousetrap.bind("up",function(a){var b=$(".fade-container:visible"),c=0.9*b.height();b.stop().animate({scrollTop:"-="+c+"px"},750);a.stopPropagation();a.preventDefault()}),Mousetrap.bind("down",function(a){var b=$(".fade-container:visible"),c=0.9*b.height();b.stop().animate({scrollTop:"+="+c+"px"},750);a.stopPropagation();
